class Appstring {
  static String onaboardingtitel1 = 'اكتشف عالم كامل\nمن النظارات';
  static String onaboardingdescription1 =
      'جرّب تجربة تسوّق فريدة تخلّي اختيار نظارتك أسهل \nوأمتع، مع تشكيلة تناسب كل الأذواق';
  static String onaboardingtitel2 = 'موضة ورؤية أوضح \nفي مكان واحد';
  static String onaboardingdescription2 =
      'من النظارات الطبية للنظارات الشمسية، كل اللي \nمحتاجه لرؤية أوضح وإطلالة أنيقة هتلاقيه عندنا';
  static String onaboardingtitel3 = 'اختار إطلالتك بثقة \nوسهولة';
  static String onaboardingdescription3 =
      'مع خطوات بسيطة وسريعة هتلاقي النظارة اللي تناسب \nأسلوبك وشخصيتك و خلال وقت قصير هتكون معاك';
  ...
  static const String nav1 = 'حسابي';
  static const String nav2 = 'السلة';
  static const String nav3 = 'الفئات';
  static const String nav4 = 'المنتجات';
  static const String nav5 = 'الرئيسية';
  static const String sectionheaderoffer = '🔥 عروضات خصيصاً لك';
  static const String sectionheadercategory = 'الفئات';
  static const String sectionheadertopsales = '🔥 الأكثر مبيعاً';
  static const String category1 = 'طبية';
  ...
  static const String cardtitel = 'نظارات ويستال';
  static const String carddesc = 'نظارات كريستال مربعة من\nخشب الأبنوس';
  static const String slidertitel = 'انضم لآلاف العيون التي رأت الفرق بنفسها';
  static const String bestoffers = 'افضل العروض';
  static const String sliderdesc = 'جودة عالية، راحة تدوم، ومظهر يخطف الأنظار';
  static const String back = 'العودة';
  static const String logintitel = 'مرحبا بعودتك معنا';
  static const String loginsubtitel =
      'اشتقنا اليك كثيرا , ادخل البيانات التالية';
  static const String signuptitel = 'يسعدنا انضمامك الينا';
  static const String signupsubtitel =
      'خطوة صغيرة تفصلك عن اختيار نظارتك المثالية';
  // 🔐 Login Form Strings
  static const String emailOrPhoneTitle = 'بريد الالكتروني او رقم الهاتف';
  ...
  static const String loginasGuest = 'الدخول ك زائر';
  // 📝 Signup Form Strings
  static const String signupEmailTitle = 'البريد الإلكتروني';
